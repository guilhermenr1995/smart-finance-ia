...
- Finance question handler:
  ...
  - It validates free-form questions, detects projection intent, applies malicious-pattern guardrails, builds contextual datasets, and returns structured answers.
...
- Behavior rules:
  ...
  - fallback answers should remain structured and practical
